            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <input
                  ...
                  className="w-full rounded-xl border border-[var(--app-border)] bg-[var(--app-surface)]/80 py-2.5 pl-3.5 pr-11 text-[var(--app-fg)] placeholder:text-[var(--app-fg)]/40 focus:border-[var(--app-navy)]/80 focus:bg-[var(--app-surface)] focus:outline-none focus:ring-2 focus:ring-[var(--app-navy)]/20 min-h-[48px] transition"
                />
                <button
                  type="button"
