...
export function CourseDetailHeaderRedesign({ course, stats }: CourseDetailHeaderRedesignProps) {
  ...
  return (
    <header className="relative mb-6 border-b border-zinc-800/80 pb-6">
      <div className="grid gap-4 lg:relative">
        <div className="flex justify-end lg:absolute lg:right-0 lg:top-0 lg:z-10">
          <div className="w-full max-w-[160px] rounded-xl border border-zinc-800 bg-zinc-900/90 p-3 shadow-sm sm:w-[160px]">
            <div className="flex items-start gap-2">
              <Flame className="h-5 w-5 shrink-0 text-orange-500" aria-hidden />
              <div>
                <p className="text-2xl font-semibold leading-none text-white tabular-nums">{course.streakDays}</p>
                <p className="mt-1 text-[10px] text-zinc-500">días de racha</p>
              </div>
            </div>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      done ? "bg-orange-500 text-white" : "bg-zinc-700 text-zinc-500",
                      isToday && "ring-1 ring-dashed ring-orange-500 ring-offset-1 ring-offset-zinc-900",
                    )}
                  >
                    {label}
                  </div>
        ...
        <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
          <div className="flex min-w-0 flex-wrap items-center gap-2">
            ...
            <span
              className="inline-flex shrink-0 items-center rounded-full px-2.5 py-0.5 text-xs font-semibold text-white sm:ml-3"
        ...
        <div className="space-y-2">
          ...
          <p className="flex flex-wrap items-center gap-x-1 gap-y-1 text-[11px] text-zinc-500">
            <span className="inline-flex items-center gap-1">
