...
import { Search, Command, Circle, Menu } from "lucide-react";
    ...
    <header className="flex h-14 flex-shrink-0 items-center justify-between gap-4 border-b border-[var(--dev-border-subtle)] bg-[var(--dev-surface-overlay)] px-4 backdrop-blur-sm sm:gap-6 sm:px-6">
      ...
      <div className="flex min-w-0 flex-1 items-center gap-4 sm:gap-6">
        <div className="flex flex-col">
          <span
            className="text-xl font-light tabular-nums text-[var(--app-fg)] sm:text-2xl"
      ...
      <div className="hidden max-w-md flex-1 lg:block">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-xl border border-[var(--dev-border-subtle)] bg-[var(--app-bg)]/70 px-4 py-2.5 text-left text-[length:var(--dev-font-body-size)] text-[var(--app-fg)]/70 transition-colors hover:border-[var(--app-navy)]/20 hover:bg-[var(--app-bg)] hover:text-[var(--app-fg)]/90"
        >
          <Search className="h-4 w-4 shrink-0" />
          <span className="flex-1 truncate">{t("commandPalette.placeholder")}</span>
          <kbd className="hidden rounded border border-[var(--dev-border-subtle)] bg-[var(--dev-surface-elevated)] px-2 py-0.5 text-[length:var(--dev-font-meta-size)] font-mono sm:inline-block">
            ⌘K
          </kbd>
        </button>
      </div>

      {/* Right: command, focus, avatar */}
      <div className="flex shrink-0 items-center gap-2 sm:gap-3">
        <button
          type="button"
          onClick={onOpenCommandPalette}
          className="flex h-9 w-9 items-center justify-center rounded-lg text-[var(--app-fg)]/60 transition-colors hover:bg-[var(--app-bg)] hover:text-[var(--app-fg)]"
        ...
        <button
          ...
          className={cn(
            ...
            isFocusMode
              ...
              : "bg-[var(--app-bg)] text-[var(--app-fg)]/60 hover:text-[var(--app-fg)]/80"
          )}
        >
          <Circle
        ...
        <div
          className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--app-navy)]/12 text-[length:var(--dev-font-body-size)] font-medium text-[var(--app-navy)]"
